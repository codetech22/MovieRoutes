...
const Comedyo = () => {
  return (
    ...
    <h1 style={{color:"aqua",position:"absolute",left:"500px"}}>Hello,Welcome to Comedy collections,<br/>select movies which you like....</h1>
    ...
    <Link to='/horroro'style={{fontSize:"15px",padding:"10px",position:"absolute",top:"390px"}}><b>Horror</b></Link>
      ...
      <div style={{height:"350px" , width:"400px" , border:"5px solid pink",position:"absolute",left:"350px",top:"200px"}}>
