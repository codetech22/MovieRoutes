...
const Mystryo = () => {
  return (
    <div style={{position:"absolute",top:"80px"}}>
      ...
      <h1 style={{color:"aqua",position:"absolute",left:"500px"}}>Hello,Welcome to Mystry collections,<br/>select movies which you like....</h1>
      ...
      <div style={{height:"350px" , width:"400px" , border:"5px solid red",position:"absolute",left:"350px",top:"200px"}}>
